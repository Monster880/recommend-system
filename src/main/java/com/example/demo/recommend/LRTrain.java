...
public class LRTrain {
    public static void main(String[] args) throws IOException {
        ...
        //加载特征及label训练文件
        JavaRDD<String> csvFile = spark.read().textFile("file:///Users/liding/Documents/demo/src/main/resources/feature.csv").toJavaRDD();
        ...
        lrModel.save("file:///Users/liding/Documents/demo/src/main/resources/lrmode");
